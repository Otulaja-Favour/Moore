...
import 'package:moove/screens/passcode_pin_screens.dart';
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: Column(
          children: [
            AuthHeader(
              title: 'Verify ${widget.verifyMode}',
              subtitle:
                  'Verify the phone number linked to your ${widget.verifyMode}',
              currentStep: widget.verifyMode == 'BVN' ? 4 : 5,
              totalSteps: 5,
